...
class EP_Related_Posts_Module extends EP_Module {
	public $slug = 'related_posts';

	public $requires_install_reindex = false;

	const CACHE_GROUP = 'ep-related-posts';
...
function ep_find_related( $post_id, $return = 4 ) {
	return EP_Module_Loader::factory()->loaded['related_posts']->find_related( $post_id, $return );
}

return new EP_Related_Posts_Module;
